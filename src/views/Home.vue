  ...
  <div class="home-wrap">
        ...
        <article :key="index" class="bg-c-white bd-round-a-xxxxsm p-a-xsm shadow-light m-t-xsm">
          <div class="flex">
            ...
            <div class="m-l-sm m-t-auto m-b-auto">
              ...
              <p
                class="m-t-xxxxsm txt-s-xxsm sm-txt-s-xxsm m-b-none txt-c-grey-shade-1"
              >By: {{post.author}}</p>
            </div>
          </div>
          <p
          ...
          <div class="flex">
            ...
            <router-link
              class="txt-c-black-shade-2 txt-s-xxsm sm-txt-s-xxsm txt-bold"
              :to="`/read/${post.id}`"
    ...
    <div class="p-a-md paging m-t-xsm container" style="max-width: 700px">
      <template v-for="(page,index) in pages">
        <router-link
          :key="index"
          :class="{'active': !page.navigable}"
          :to="`?page=${page.page_number}`"
        >
